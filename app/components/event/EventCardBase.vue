...
<template>
  <article
    class="bg-base-200/60 backdrop-blur-sm hover:bg-base-200 border border-base-content/10 border-l-4 rounded-lg cursor-pointer transition-all shadow-lg hover:shadow-xl overflow-hidden focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
