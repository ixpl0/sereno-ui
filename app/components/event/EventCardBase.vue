...
<template>
  <article
    class="card-glass backdrop-blur-sm border-l-4 rounded-lg cursor-pointer transition-all duration-200 shadow-2xl ring-1 hover:shadow-primary/20 hover:scale-[1.01] overflow-hidden focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2"
