import { addMockAlertAnnotation, isValidToken } from '../../../../../utils/mockData'
...
export default defineEventHandler(async (event) => {
  ...
  if (!body.key || !body.value) {
    throw createError({
      statusCode: 400,
      statusMessage: 'Bad Request',
      data: { error: { code: 'bad_request', message: 'Annotation key and value are required' } },
    })
  }

  const alert = addMockAlertAnnotation(id, body.key, body.value)
