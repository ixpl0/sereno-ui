import { addMockIncidentAlert, isValidToken } from '../../../../../utils/mockData'
...
export default defineEventHandler(async (event) => {
  ...
  const incident = addMockIncidentAlert(id, body.id)

  if (!incident) {
    throw createError({
      statusCode: 404,
      statusMessage: 'Not Found',
      data: { error: { code: 'not_found', message: 'Incident or Alert not found' } },
    })
  }
